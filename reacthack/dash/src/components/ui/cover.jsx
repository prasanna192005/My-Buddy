  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={`dark:text-white inline-block text-neutral-900 relative z-20 group-hover/cover:text-white transition duration-200 ${className}`}
      >
        {children}
      </motion.span>
...
export const CircleIcon = ({ className, delay }) => {
  return (
    <div
      className={`pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 group h-2 w-2 rounded-full bg-neutral-600 dark:bg-white opacity-20 group-hover/cover:bg-white ${className}`}
    ></div>
  );
};
